...
contract MINIDOGToken is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x85b8a9caEa3394bd00fD0Fc0aF81A15067BEB772); // Marketing Address
    ...
    //100,000,000,000,000,000,000,000 TOKEN
    uint256 private _tTotal = 1000000000 * 10**14 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MINIDOG TOKEN";
    string private _symbol = "TINIDAWG";
    ...
    uint256 public _liquidityFeeWhenBuy = 5;
    
    // 1%
    uint256 public _maxTxAmount = 10000000 * 10**14 * 10**9;
    // 0.1%
    uint256 private minimumTokensBeforeSwap = 1000000 * 10**14 * 10**9; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000 * 10**14 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 3;
        _liquidityFee = 11;
        _maxTxAmount = 10000000 * 10**14 * 10**9;
    }
